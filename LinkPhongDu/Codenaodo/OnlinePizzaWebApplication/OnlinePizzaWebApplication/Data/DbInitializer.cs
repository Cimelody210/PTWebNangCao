...
namespace OnlinePizzaWebApplication.Data
{
    public class DbInitializer
    {
        ...
        {
            var cat1 = new Categories { Name = "Tiêu Chuẩn", Description = "Các loại pizza Tiêu Chuẩn của Bếp Của Tiệm quanh năm." };
            var cat2 = new Categories { Name = "Đặc Sản", Description = "Các loại pizza Đặc Sản của Bếp Của Tiệm chỉ có trong một khoảng thời gian hạn chế." };
            var cat3 = new Categories { Name = "Mới", Description = "Các loại pizza Mới của Bếp Của Tiệm trên thực đơn." };
            ...
            var piz5 = new Pizzas { Name = "Kebab Đặc Biệt", Price = 85.00M, Category = cat2, Description = "Một chiếc pizza đặc biệt với kebab cho những người đói.", ImageUrl = "http://2.bp.blogspot.com/_3cSn3Qz_4IA/THkYqKwGw1I/AAAAAAAAAPg/ybKpvRbjDWE/s1600/matsl%C3%A4kten+002.JPG", IsPizzaOfTheWeek = true };
